 ...
 *
 * Siebe Projects samples is free software: you can redistribute it and/or
 * modify
 ...
 * along with Siebe Projects samples.  If not, see <http://www.gnu
 * .org/licenses/>.
 */
 ...
 * to calculate the window height when the floating keyboard is opened and
 * closed.
 */
public class KeyboardHeightProvider extends PopupWindow {
    ...
    /**
     * Start the KeyboardHeightProvider, this must be called after the
     * onResume of the Activity.
     * PopupWindows are not allowed to be registered before the onResume has
     * finished
     * of the Activity.
     */
    void start() {
    ...
    private void handleOnGlobalLayout() {
        ...
        // REMIND, you may like to change this using the fullscreen size of
        // the phone
        // and also using the status bar and navigation bar heights of the
        // phone to calculate
